...
<script type="text/javascript" src="<%=path%>/js/page/orderCount_manage.js"></script>
</head>	
<body>
		...
		<div style="width:100%; margin:20px auto;">
			<form id="ff" class="easyui-form" method="post" >
				<table style="width:100%; margin:auto; border-collapse:separate; border-spacing:15px;">
					<tr>
						<td align="left" width="30%">订单统计起止时间:</td>
						...
						<td width="40%"><a href="javascript:void(0)" class="easyui-linkbutton" style="width: 100px;height: 25px" onclick="searchInfo()">筛选</a>
