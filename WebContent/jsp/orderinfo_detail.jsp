...
<body>
	...
	<table style="width:100%; margin:auto; border-collapse:separate; border-spacing:15px;font-size:14px">
		...
		<tr>
			<td align="left">
				<table style="width:100%; margin:auto; border-collapse:separate; border-spacing:15px;font-size:14px">
					<tr>
						<td rowspan="3"><img src="${imgIpHost}/${photo}" width="100px" height="100px"></td>
					</tr>
					<tr>
						<td width="50%">昵称：${userinfo.nickname}</td>
					</tr>
					<tr>
						<td>手机：${userinfo.username}</td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table style="width:100%; margin:auto; border-collapse:separate; border-spacing:15px;font-size:14px">
		<tr>
			<td align="left">项目：${servicename}</td>
		</tr>
		<tr>
			<td align="left">
