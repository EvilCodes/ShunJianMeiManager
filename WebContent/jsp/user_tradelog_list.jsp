...
<script type="text/javascript" src="<%=path%>/js/page/user_tradelog_list.js?<%=SECOND%>"></script>
</head>	
<body>
	<div class="main" style="background:none; width: 1000px; height: 580px;">
